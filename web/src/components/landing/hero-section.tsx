...
import { detectOS, getPrimaryDownload, formatFileSize, type DownloadAsset } from '@/lib/download-utils';
import { useEffect, useState } from 'react';

export function HeroSection() {
  const [primaryDownload, setPrimaryDownload] = useState<DownloadAsset | null>(null);
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-zinc-900">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <h1
            className="text-5xl lg:text-7xl font-bold mb-8 relative gradient-text"
            style={{
              WebkitTextStroke: '2px #a78bfa',
              filter: 'drop-shadow(0 0 12px #a78bfa) drop-shadow(0 0 28px #a78bfa)',
            }}
          >
            ⌘ Writter
          </h1>
        ...
        >
          ...
          <p className="text-lg text-zinc-400 max-w-2xl mx-auto leading-relaxed">
            Fully offline-first desktop editor that focuses on local-first simplicity, 
            speed, and the power of pure thought to action. Free and open source.
          </p>
        </motion.div>
        ...
        >
          <Button
            ...
            className="bg-violet-600 hover:bg-violet-700 text-white shadow-lg shadow-violet-600/25 group"
          >
          ...
          <Button
            ...
            className="border-zinc-600 text-zinc-300 hover:bg-zinc-800 group"
          >
        ...
        >
          v0.0.9 Beta • Free & Open Source • Available for Windows, macOS & Linux
        </motion.div>
      </div>
