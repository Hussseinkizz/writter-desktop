...
export function getLatestReleaseAssets(): DownloadAsset[] {
  ...
  const baseUrl =
    'https://github.com/Hussseinkizz/writter-desktop/releases/download/app-v0.0.10';

  return [
    {
      name: 'Windows Installer',
      url: `${baseUrl}/writter_0.0.10_x64-setup.exe`,
      os: 'windows',
      size: 3210462,
      type: 'exe',
    },
    {
      name: 'Windows MSI',
      url: `${baseUrl}/writter_0.0.10_x64_en-US.msi`,
      os: 'windows',
      size: 4481024,
      type: 'msi',
    },
    {
      ...
      url: `${baseUrl}/writter_0.0.10_universal.dmg`,
      os: 'macos',
      size: 9271620,
      type: 'dmg',
    },
    {
      name: 'Linux Debian',
      url: `${baseUrl}/writter_0.0.10_amd64.deb`,
      os: 'linux',
      size: 5532910,
      type: 'deb',
    },
    {
      name: 'Linux AppImage',
      url: `${baseUrl}/writter_0.0.10_amd64.AppImage`,
      os: 'linux',
      size: 90047680,
      type: 'appimage',
    },
    {
      name: 'Linux RPM',
      url: `${baseUrl}/writter-0.0.10-1.x86_64.rpm`,
      os: 'linux',
      size: 5533777,
      type: 'rpm',
    },
